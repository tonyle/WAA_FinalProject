  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Link to="/owner/property-management" className="bg-green-500 text-white p-4 rounded-md text-center">Manage Properties</Link>
        <Link to="/owner/offers" className="bg-yellow-500 text-white p-4 rounded-md text-center">View Offers</Link>
