    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                                ...
                                .requestMatchers(HttpMethod.POST,"/api/v1/properties/**").hasAnyAuthority(roles3)
                                .requestMatchers(HttpMethod.PUT,"/api/v1/properties/**").hasAnyAuthority(roles5)
                                .requestMatchers(HttpMethod.POST,"/api/v1/offers/**").hasAnyAuthority(roles1)
                                .requestMatchers(HttpMethod.PUT,"/api/v1/offers/**").hasAnyAuthority(roles3)
